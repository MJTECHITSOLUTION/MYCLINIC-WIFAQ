...
<head>
    ...
    <title>Tayssir - @yield('title') </title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @empty(!$lastPatientId)
                            <a href="{{ url('patient/view/'.$lastPatientId) }}" role="button" style="position: relative ; top: 12px; right: 5px;">
                                @empty(!$imagePatient)
                                    <center><img src="{{ asset('uploads/'.$imagePatient) }}" class="img-profile rounded-circle img-fluid" width="40" height="40"></center>
                                @else
                                    <center><img src="{{ asset('img/patient-icon.png') }}" class="img-profile rounded-circle img-fluid" width="40" height="40"></center>
                                @endempty
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright my-auto">
                        <span>Copyright &copy; Created by <a href="https://tayssir.cloud" target="_blank"> MJTech Solutions</a> {{ date('Y') }}</span>
