...
@section('footer')
                ...
                success: function (consultation) {
                    ...
                    if (consultation && consultation.length > 0) {
                        ...
                        for (var actId in uniqueActs) {
                            ...
                            statusSelect.append($('<option>').val('Termine').text('Termine'));
                            ...
                            var prixInput = $('<input type="text" name="" class="form-control prix-input">');
    ...
    <script>
        ...
        // $(function() {
        //     $('#map-image').mapster({
        //         fillOpacity: 0.4, // Adjust this value to change the highlight opacity
        //         selected: false, // Set to true if you want the area to be selected initially
        //         onClick: function(e) {
        //             // This function will be called when the user clicks on an area.
        //             // The 'e' parameter contains information about the clicked area.
        //             console.log('Clicked area:', e.target.alt);
        //         }
        //     });
        // });
    </script>
