            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        {{--                    <input type="submit" value="Modifier le graph" class="btn rounded-0  btn-primary " align="right" style=";position: absolute; right: 30px; top: 8px;"> --}}
                    </div>
                    <div class="card-body">
                        <fieldset class="drugs_labels">
                            <div class="chart-container">
                                @foreach ($gras as $gra)
                                    <img src="{{ asset('img/graph/' . $gra->image . '.png') }}" id="chart-image"
                                ...
                                @foreach ($statistics as $statistic)
                                    ...
                                    <div class="point point-marker"
                                        style="left: {{ $statistic->x }}px; top: {{ $statistic->y }}px; background-color: red;"
                                        data-point-id="{{ $statistic->id }}">
