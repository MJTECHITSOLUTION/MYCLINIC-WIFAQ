        ...
        $(document).ready(function() {
            $('#PatientID').on('change', function() {
                ...
                if (birthday) {
                    ...
                    patientInfo += '<p><b>{{ __('sentence.Birthday') }} :</b> ' + birthday + ' (' + age.years + ' ans et ' + age.months + ' mois)</p>';
                }
                if (phone) {
                ...
                {{--if (weight) {--}}
                    {{--    patientInfo += '<p><b>{{ __('sentence.Weight') }} :</b> ' + weight + ' Kg</p>';--}}
                    {{--}--}}
                    {{--if (height) {--}}
...
{{--<script>--}}
{{--    $(document).ready(function() {--}}
{{--        // Function to update the image when an option is selected--}}
{{--        function updateImage() {--}}
{{--            const selectedOption = $('#label').find('option:selected');--}}
...
{{--        // Call the function whenever the dropdown selection changes--}}
