...
class PatientController extends Controller
{
        ...
        if(Auth::user()->role == 'Médecin'){
            $patients = User::where('role', '=', 'patient')
                ...
                ->where(function($query) {
                    $query->where('patients.dr_id', '=', Auth::user()->id)
    ...
    public function edit($id)
    {
        ...
        return view('patient.edit', ['patient' => $patient, 'assurances' => $assurances, 'doctors' => $doctors]);
    }
    ...
    { 
        {
            ...
            return view('patient.create', compact('assurances', 'doctors'));
        }
    }
    ...
    public function view($id)
    {
        ...
        $invoicesFacture = Billing::where('user_id', $id)->where('facture',1)->orderBy('id', 'Desc')->get();
        ...
        return view('patient.view', [
            ...
            'invoices' => $invoices,
            'invoicesFacture'=> $invoicesFacture,
            'documents' => $documents,
            'historys' => $historys,
            'graphs' => $graphs,
