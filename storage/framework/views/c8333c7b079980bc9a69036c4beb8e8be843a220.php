        ...
        <div class="card-header py-3">
            <div class="row mb-3">
               ...
               <div class="col-6 text-right">
                   Total : <?php echo e($total_payments_range); ?> <?php echo e(App\Setting::get_option('currency')); ?>

                   <br>
                   Rest à payer : <?php echo e($total_payments_range - $restapaye); ?> <?php echo e(App\Setting::get_option('currency')); ?>
            ...
            <div class="table-responsive">
                <table  class="table table-striped table-bordered table-striped table-responsive{-sm|-md|-lg|-xl|-xxl}"
                    ...
                    <tr>
                        ...
                        <th class="text-center sm__screen">Payé</th>
                        <th class="text-center sm__screen">Rest à payer</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center sm__screen"> <?php echo e(App\Billing_item::where('billing_id', $payment->id)->sum('payer')); ?> <?php echo e(App\Setting::get_option('currency')); ?></td>
                            <td class="text-center sm__screen"> <?php echo e($payment->total_without_tax - App\Billing_item::where('billing_id', $payment->id)->sum('payer')); ?> <?php echo e(App\Setting::get_option('currency')); ?></td>
                            <td class="text-center sm__screen"> <?php echo e($payment->total_without_tax); ?> <?php echo e(App\Setting::get_option('currency')); ?></td>
    ...
    <div id="print_div" style="display: none">
        ...
        <table  class="table table-striped table-bordered table-striped table-responsive{-sm|-md|-lg|-xl|-xxl}"
            ...
            <tr>
                ...
                <th class="text-center sm__screen"><b>Payé</b></th>
                <th class="text-center sm__screen"><b>Rest à payer</b></th>
            ...
            <?php if(count($payments) > 0): ?>
                <tr class="font-weight-bold">
                    ...
                    <td class="text-center sm__screen">
                        <?php echo e($payments->sum(function($payment) { return App\Billing_item::where('billing_id', $payment->id)->sum('payer'); })); ?> 
                        <?php echo e(App\Setting::get_option('currency')); ?>

                    </td>
                    <td class="text-center sm__screen">
                        <?php echo e($payments->sum(function($payment) { return $payment->total_without_tax - App\Billing_item::where('billing_id', $payment->id)->sum('payer'); })); ?> 
                        <?php echo e(App\Setting::get_option('currency')); ?>

                    </td>
                    <td class="text-center sm__screen">
                        <?php echo e($payments->sum('total_without_tax')); ?> 
                        <?php echo e(App\Setting::get_option('currency')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\dr-rmili\resources\views/record/payment.blade.php ENDPATH**/ ?>