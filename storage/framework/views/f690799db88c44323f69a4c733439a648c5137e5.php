            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('doctorino_settings.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="ville" class="col-sm-3 col-form-label">Nom arabe</label>
                            <div class="col-sm-9">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dr-imanebenjelloun.tayssir.cloud/resources/views/settings/doctorino_settings.blade.php ENDPATH**/ ?>