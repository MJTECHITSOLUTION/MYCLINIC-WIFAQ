            ...
            <div class="row">
               <div class="col" >
                  <?php if(!empty(App\Setting::get_option('logo'))): ?>
                     <img src="<?php echo e(asset('uploads/'.App\Setting::get_option('logo'))); ?>" style="width: 50%;"><br><br>
                  <?php endif; ?>
                           ...
                           <?php $__currentLoopData = $billing_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $billing_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <tr>
                                   <?php
                                       ...
                                       $restbilling = $billing_item->invoice_amount - $billing_item->payer ;
                                   ...
                                   <td><?php echo e(isset($billing_item->payer) ? $billing_item->payer : 'N/A'); ?></td>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /var/www/dr-imanebenjelloun.tayssir.cloud/resources/views/billing/specialty/dentiste/view.blade.php ENDPATH**/ ?>