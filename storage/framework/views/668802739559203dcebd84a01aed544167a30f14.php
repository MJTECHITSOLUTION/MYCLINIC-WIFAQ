                    ...
                    <tr>
                        <?php $__empty_1 = true; $__currentLoopData = $notehonoraire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo e(route('notehonoraire.edit', $note->id)); ?>"
                                   class="btn btn-outline-primary btn-circle btn-sm"><i class="fas fa-edit"></i></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/notehonoraire/all.blade.php ENDPATH**/ ?>