    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                ...
                <div class="sidebar-brand-text mx-3"><img src="<?php echo e(asset('uploads/'.App\Setting::get_option('logo'))); ?>" class="img-fluid" style="margin-top: 20px"></div>
            </a>
            <!-- Divider -->
            <br>
                    ...
                    <div id="collapsenote" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all invoices')): ?>
                                <a class="collapse-item" href="<?php echo e(route('notehonoraire.create')); ?>">Ajouter note d'honoraire</a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all invoices')): ?>
                                <a class="collapse-item" href="<?php echo e(route('notehonoraire.all')); ?>">Tous les notes d'honoraire</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </li>
                           ...
                           <li class="nav-item">
                              ...
                              <div id="collapseBilling" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                                 <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all invoices')): ?>
                                    <a class="collapse-item" href="<?php echo e(route('billing.all')); ?>">Liste des paiements</a>
                                    <?php endif; ?>
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all invoices')): ?>
                                    <a class="collapse-item" href="<?php echo e(route('billing.facture')); ?>"><?php echo e(__('sentence.Billing List')); ?></a>
                                    <?php endif; ?>
                                 </div>
                              </div>
                           </li>
            ...
            <?php if(isset($salle_soin)): ?>
                <div class="col-auto d-xl-block d-none">
                    <div class="header_notification d-flex align-items-center notification-wrapper">
                        <div class="notification_icon">
                            <img src="<?php echo e(asset('img/thumbnail.png')); ?>" class="img-fluid my_img_profil" alt="user" style="max-width: 30px;">
                        </div>
                        <p class="notification_text">
                            <?php if(isset($salle_soin->name)): ?>
                                <a href="<?php echo e(url('patient/view/'.$salle_soin->user_id)); ?>" role="button">
                                    <span><?php echo e($salle_soin->name); ?></span>
                                </a>
                            <?php endif; ?>
                        </p>
                    </div>
                        ...
                        <li class="nav-item dropdown no-arrow" style="margin-left: 250px;">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo e(asset('img/rmili.png')); ?>">
                            </a>
...
<?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/layouts/specialty/dentiste/master.blade.php ENDPATH**/ ?>