            ...
            <div class="col-10">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(count($prescription_medicament) > 0): ?>
                            <!-- ROW: Drugs List -->
                            <div class="row justify-content-center">
                                <div class="col">
                                    <ul>
                                        <?php $__currentLoopData = $prescription_medicament; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($medicament->medicament); ?><br>
                                                <?php echo e($medicament->drug_advice); ?></li>
                                            <?php if($loop->last): ?>
                                                <div style="margin-bottom: 40px;"></div>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <?php $__currentLoopData = $consultation_act; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="table-row">
                                                        ...
                                                        <td>
                                                            <?php if(isset($act->haut)): ?>
                                                                <?php echo e($act->haut); ?>-
                                                            <?php endif; ?>
                                                            <?php if(isset($act->gauche)): ?>
                                                                <?php echo e($act->gauche); ?>-
                                                            <?php endif; ?>
                                                            <?php if(isset($act->droite)): ?>
                                                                <?php echo e($act->droite); ?>-
                                                            <?php endif; ?>
                                                                <?php if(isset($act->bas)): ?>
                                                                    <?php echo e($act->bas); ?>-
                                                                <?php endif; ?>
                                                            <?php echo e($act->dent); ?>
                ...
                <div class="col">
                    <ol>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(App\Setting::get_option('use_pied') === 'yes'): ?>
                                    <img src="<?php echo e(asset('uploads/' . App\Setting::get_option('piedrapport'))); ?>"
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/prescription/specialty/dentiste/view.blade.php ENDPATH**/ ?>