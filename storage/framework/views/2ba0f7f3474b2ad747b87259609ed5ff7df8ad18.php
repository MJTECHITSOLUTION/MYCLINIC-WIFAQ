                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="form-group" style="display: none;">
                                <label for="Medcin">Médecin</label>
                                    <select class="form-control multiselect-doctorino" id="Medcin" onchange="updateDoctor()">
            ...
            <div class="modal-content">
               ...
               document.getElementById('rdv-form').submit();"><?php echo e(__('sentence.Save')); ?></a>
                    <form id="rdv-form" action="<?php echo e(route('appointment.store')); ?>" method="POST" class="d-none">
                        ...
                        <?php if(Auth::user()->role == 'Médecin'): ?>
                            <input type="hidden" name="doctor_id" id="doctor_id" value="<?php echo e(Auth::user()->id); ?>">
                        <?php else: ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        function updateDoctor() {
            // Get the selected value from the dropdown
            var selectedDoctor = document.getElementById('Medcin').value;

            // Update the hidden input field
            document.getElementById('doctor_id').value = selectedDoctor;
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\dr-rmili\resources\views/appointment/create.blade.php ENDPATH**/ ?>