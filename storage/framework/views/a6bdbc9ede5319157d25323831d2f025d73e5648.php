                            ...
                            <select class="form-control rounded-0 shoadow-none shadow-none rounded-0 select2"
                                ...
                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($patient->id); ?>"
                                            <?php if($user_id == $patient->id || $lastPatientId == $patient->id): ?> selected <?php endif; ?>>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <?php $__currentLoopData = $actes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table-row">
                                        ...
                                        <td> <?php if(isset($act->libelle_act)): ?>
                                                <?php echo e($act->libelle_act); ?>
                                        ...
                                        <td><?php echo e($act->status); ?>
                                            ...
                                            <input type="hidden" name="consultation_act_id[]"
                                                   value="<?php echo e($act->consultation_act_idc); ?>">
                                        </td>
                                        <td><?php echo e($act->dent); ?></td>
                                        <td><?php echo e($act->prix); ?>

                                            <input type="hidden" name="prix[]" class="prix" id="prix"
                                                   value="<?php echo e($act->prix); ?>">
                                        </td>
                                        <td style="display: none;">
                                            <input type="text" class="form-control" data-row="<?php echo e($loop->index); ?>"
                                                   name="payer_input[]" id="payer" value="<?php echo e($act->payer ?? '0'); ?>"
                                                   readonly>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <a class='addObservation' data-toggle="modal" data-target="#billingModal"
                                               data-act-id="<?php echo e($act->consultation_act_idc); ?>">
                                ...
                                <?php if(isset($deleted_actes)): ?>
                                    <?php $__currentLoopData = $deleted_actes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="table-row">
                                            ...
                                            <td><?php echo e($act->dent); ?></td>
                                            <td><?php echo e($act->prix); ?> <input type="hidden" name="prix[]" class="prix"
                                                                        value="<?php echo e($act->prix); ?>"></td>
                                            <td>
                                                <input type="text" class="form-control" data-row="<?php echo e($loop->index); ?>"
                                                       name="payer_input[]" value="<?php echo e($act->payer ?? '0'); ?>" readonly>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control payer-input" name="a_payer"
                                                       data-row="<?php echo e($loop->index); ?>">
                                                <input type="hidden" class="form-control payer-input montant_facture"
                                                       name="payer[]">
                                                <br>
                                                <input type="hidden" class="form-control" name="" id="total">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select type="text" name="invoice_title[]" class="form-control invoice-title"
                            placeholder="<?php echo e(__('sentence.Invoice Title')); ?>" required>
                        <option value="">Sélectionner</option>
                        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($payment->name); ?>"
                                    data-price="<?php echo e($payment->price); ?>"><?php echo e($payment->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/billing/specialty/dentiste/create.blade.php ENDPATH**/ ?>