...
<body>
<form method="post" action="<?php echo e(route('notehonoraire.update', $note->id)); ?>">
    <?php echo csrf_field(); ?>
                        ...
                        <select
                            ...
                            oninvalid="this.setCustomValidity('Selectionner le patient SVP!')" disabled>
                                ...
                                <option value="<?php echo e($patient->id); ?>"
                                        ...
                                        <?php if($note->patient_id == $patient->id): ?> selected <?php endif; ?>>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <table id="rapportTable" class="table">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><input type="text" name="old_act_name[]" class="form-control" value="<?php echo e($act->act_name); ?>"></td>
                                <td><input type="text" name="old_code[]" class="form-control" value="<?php echo e($act->code); ?>"></td>
                                <td><input type="text" name="old_lettrecle[]" class="form-control" value="<?php echo e($act->lettrecle); ?>"></td>
                                <td><input type="date" name="old_date[]" class="form-control" value="<?php echo e(\Carbon\Carbon::parse($act->date)->format('Y-m-d')); ?>"></td>
                                <td><input type="text" name="old_dents[]" class="form-control" value="<?php echo e($act->dent); ?>"></td>
                                <td><input type="number" name="old_montant[]" class="form-control" value="<?php echo e($act->montant); ?>">
                                <input type="hidden" name="old_id[]" value="<?php echo e($act->honorire_id); ?>"></td>
                                <td class="text-center">
                                    <form action="<?php echo e(route('notedelete.destroy', $act->honorire_id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette note ?');">
                                        <?php echo method_field('PUT'); ?>
                                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        function addRow(event) {
            ...
            var acts = <?php echo json_encode($acts, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/notehonoraire/edit.blade.php ENDPATH**/ ?>