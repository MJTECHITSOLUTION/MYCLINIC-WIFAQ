        ...
        <div class="row justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <option value="<?php echo e($prescription->user_id); ?>"><?php echo e($prescription->User->name); ?> -
                                (<?php echo e(calculateAgeWithMonths($prescription->User->Patient->birthday)); ?>)
                            </option>
                        ...
                        <div class="form-group">
                            <div class="card-body text-center" style="padding: 0px;">
                                <img src="<?php echo e(asset('img/dent.png')); ?>" id="map-image"
                                     style="min-width: 350px; max-width: 350px; height: auto;" alt="" usemap="#map"/>
                                <map name="map">
                                    <area shape="poly"
                                          coords="266, 272, 280, 276, 282, 295, 279, 302, 255, 305, 248, 295, 247, 282"
                                          onclick="('38')" title="38"/>
                                    <area shape="poly"
                                          coords="264, 306, 277, 308, 281, 324, 274, 340, 240, 336, 239, 315, 250, 306"
                                          onclick="('37')" title="37"/>
                                    <area shape="poly"
                                          coords="261, 381, 270, 372, 274, 355, 268, 340, 246, 340, 235, 345, 231, 368"
                                          onclick="('36')" title="36"/>
                                    <area shape="poly"
                                          coords="249, 401, 255, 396, 256, 382, 244, 376, 231, 380, 227, 389"
                                          onclick="('35')" title="35"/>
                                    <area shape="poly" coords="232, 401, 243, 403, 243, 416, 236, 425, 219, 419"
                                          onclick="('34')" title="34"/>
                                    <area shape="poly"
                                          coords="209, 421, 224, 425, 231, 429, 229, 441, 216, 446, 202, 429"
                                          onclick="('33')" title="33"/>
                                    <area shape="poly"
                                          coords="190, 438, 198, 435, 207, 437, 209, 448, 198, 458, 185, 442, 187, 440"
                                          onclick="('32')" title="32"/>
                                    <area shape="poly" coords="171, 448, 182, 445, 188, 448, 188, 458, 174, 463"
                                          onclick="('31')" title="31"/>
                                    <area shape="poly" coords="152, 445, 164, 446, 166, 454, 166, 463, 146, 458"
                                          onclick="('41')" title="41"/>
                                    <area shape="poly"
                                          coords="135, 435, 145, 435, 146, 442, 148, 451, 141, 456, 126, 453"
                                          onclick="('42')" title="42"/>
                                    <area shape="poly"
                                          coords="123, 421, 132, 423, 132, 429, 128, 438, 123, 445, 105, 439"
                                          onclick="('43')" title="43"/>
                                    <area shape="poly"
                                          coords="103, 400, 111, 401, 113, 409, 116, 417, 113, 426, 102, 425, 91, 417, 93, 409"
                                          onclick="('44')" title="44"/>
                                    <area shape="poly"
                                          coords="96, 377, 104, 381, 107, 392, 98, 399, 93, 402, 80, 396, 79, 387"
                                          onclick="('45')" title="45"/>
                                    <area shape="poly"
                                          coords="95, 339, 102, 348, 104, 359, 103, 372, 83, 380, 73, 380, 61, 359, 61, 348, 77, 343"
                                          onclick="('46')" title="46"/>
                                    <area shape="poly"
                                          coords="83, 306, 94, 308, 98, 323, 97, 332, 89, 340, 67, 341, 59, 329, 57, 313"
                                          onclick="('47')" title="47"/>
                                    <area shape="poly"
                                          coords="77, 271, 88, 278, 91, 292, 88, 301, 72, 307, 60, 304, 54, 294, 57, 276"
                                          onclick="('48')" title="48"/>
                                    <area shape="poly"
                                          coords="77, 213, 90, 218, 92, 230, 85, 242, 70, 248, 55, 241, 54, 221, 61, 215"
                                          onclick="('18')" title="18"/>
                                    <area shape="poly"
                                          coords="77, 178, 92, 185, 95, 198, 90, 210, 69, 212, 55, 207, 55, 190, 60, 182"
                                          onclick="('17')" title="17"/>
                                    <area shape="poly"
                                          coords="94, 149, 100, 152, 99, 165, 95, 180, 67, 176, 58, 169, 61, 150, 71, 143"
                                          onclick="('16')" title="16"/>
                                    <area shape="poly"
                                          coords="101, 125, 104, 133, 99, 144, 84, 145, 72, 137, 72, 121, 79, 119, 91, 119"
                                          onclick="('15')" title="15"/>
                                    <area shape="poly" coords="113, 106, 112, 114, 100, 120, 87, 115, 82, 104, 93, 93"
                                          onclick="('14')" title="14"/>
                                    <area shape="poly"
                                          coords="112, 69, 104, 72, 99, 76, 96, 84, 101, 90, 108, 96, 118, 97, 125, 89, 125, 84, 122, 74"
                                          onclick="('13')" title="13"/>
                                    <area shape="poly"
                                          coords="135, 58, 123, 62, 120, 69, 127, 78, 137, 79, 143, 72, 144, 63"
                                          onclick="('12')" title="12"/>
                                    <area shape="poly" coords="164, 65, 152, 67, 142, 59, 149, 50, 160, 45, 168, 60"
                                          onclick="('11')" title="11"/>
                                    <area shape="poly"
                                          coords="185, 68, 174, 63, 171, 54, 171, 45, 184, 46, 195, 50, 196, 62"
                                          onclick="('21')" title="21"/>
                                    <area shape="poly" coords="195, 70, 208, 82, 218, 64, 207, 58, 199, 58"
                                          onclick="('22')" title="22"/>
                                    <area shape="poly"
                                          coords="244, 85, 241, 74, 231, 70, 221, 70, 218, 78, 216, 88, 222, 96"
                                          onclick="('23')" title="23"/>
                                    <area shape="poly"
                                          coords="257, 106, 253, 97, 245, 92, 234, 92, 230, 101, 229, 111, 233, 119, 252, 117"
                                          onclick="('24')" title="24"/>
                                    <area shape="poly"
                                          coords="268, 133, 267, 122, 259, 117, 247, 118, 236, 128, 238, 139, 247, 144, 263, 142"
                                          onclick="('25')" title="25"/>
                                    <area shape="poly"
                                          coords="276, 172, 280, 164, 279, 150, 270, 144, 257, 144, 242, 148, 240, 160, 240, 173, 243, 181"
                                          onclick="('26')" title="26"/>
                                    <area shape="poly"
                                          coords="282, 205, 283, 187, 273, 178, 258, 179, 248, 185, 243, 200, 254, 213, 280, 210"
                                          onclick="('27')" title="27"/>
                                    <area shape="poly"
                                          coords="283, 236, 280, 244, 261, 247, 246, 237, 249, 218, 267, 214, 279, 217"
                                          onclick="('28')" title="28"/>
                                </map>
                            </div>
                        </div>
            ...
            <div class="col-md-8">
                                ...
                                <div class="form-row">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" name="value[]" class="form-control"
                                               value="<?php echo e($rapport->value); ?>" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <br>
                                        <a href="<?php echo e(route('remove-rapport', ['id' => $rapport->id])); ?>"
                                           class="btn rounded-0  btn-danger btn-sm text-white span-2"><i
                                                class="fa fa-times-circle"></i> <?php echo e(__('sentence.Remove')); ?></a>
                                    </div>
                                    <label for="rapport">Rapport d'examen</label>
                                    <textarea class="form-control rounded-0 shadow-none analyse" name="rapport[]"
                                              placeholder=""><?php echo e($rapport->rapport); ?></textarea>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="haut" id="haut"
                                                       value="Haut" <?php echo e($prescription->haut == 'Haut' ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="haut">Haut</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="droite"
                                                       id="droite"
                                                       value="Droite" <?php echo e($prescription->droite == 'Droite' ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="droite">Droite</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="gauche"
                                                       id="gauche"
                                                       value="Gauche" <?php echo e($prescription->gauche == 'Gauche' ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="gauche">Gauche</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="bas" id="bas"
                                                       value="Bas" <?php echo e($prescription->bas == 'Bas' ? 'checked' : ''); ?>>
                            ...
                            <br>
                            <div class="col-md-10">
                                <select class="form-control act_input" id="acte" name="acte">
                                    ...
                                    <?php $__currentLoopData = $actes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($act->id); ?>" data-acte-ref="<?php echo e($act->ref); ?>"
                                                data-acte-cout="<?php echo e($act->cout); ?>"><?php echo e($act->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <table id="acteTable" class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $consultationact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if(isset($acte->libelle_act)): ?>
                                            <?php echo e($acte->libelle_act); ?>

                                        <?php else: ?>
                                            <?php echo e($acte->name); ?>
                                    ...
                                    <td><input type="number" name="prix[]" class="form-control"
                                               value="<?php echo e($acte->prix); ?>"></td>
                                    
                                    
                                    
                                    </td>
                                    <td><a href="<?php echo e(route('remove-acte', ['id' => $acte->id])); ?>" class="btn"><i
                                                class='fas fa-trash'></i></a></td>
                                    <input type="hidden" name="prescription_consultation_id[]" id="prescription_id"
                                           value="<?php echo e($acte->prescription_id); ?>">
                                    <input type="hidden" name="act_id[]" id="act_id" value="<?php echo e($acte->id); ?>">
                                    <input type="hidden" name="consultation_act_id[]" id="consultation_act_id"
                                           value="<?php echo e($acte->id); ?>">
                                    <input type="hidden" name="observation[]" id="observation"
                                           value="<?php echo e($acte->observation); ?>">
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
                ...
                <div class="modal fade" id="observationModal" tabindex="-1" role="dialog"
                     aria-labelledby="observationModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <select
                                                    ...
                                                    name="trade_name[]" id="drugs" tabindex="-1" aria-hidden="true"
                                                    required>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <fieldset class="medicament_labels">
                            <div class="repeatable">
                                <?php $__currentLoopData = $prescription_medicament; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <section class="field-group">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <select
                                                    class="form-control rounded-0 shadow-none multiselect-drug"
                                                    name="medicament[]" id="" tabindex="-1" aria-hidden="true"
                                                    required>
                                                    <option value="<?php echo e($medicament->medicament_id); ?>">
                                                        <?php echo e($medicament->medicament); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group-custom">
                                                    <input type="text" id="" name="medadvice[]"
                                                           class="form-control rounded-0 shadow-none"
                                                           placeholder="<?php echo e(__('sentence.Advice_Comment')); ?>"
                                                           value="<?php echo e($medicament->drug_advice); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="<?php echo e(route('prescription_medicament.destroy', $medicament->medicament_id)); ?>"
                                                   class="btn rounded-0 btn-danger btn-sm text-white delete"
                                                   onclick="event.preventDefault(); deleteMedicament('<?php echo e(route('prescription_medicament.destroy', $medicament->medicament_id)); ?>');">
                                                    <i class="fa fa-trash font-size-12"></i> <?php echo e(__('sentence.Remove')); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script type="text/template" id="fai_labels">
        <div class="field-group row">
            <div class="form-group col-md-12">
                <label>Radios </label>
                <select class="form-control rounded-0 shoadow-none shadow-none rounded-0 multiselect-radio"
                        name="radio_id_new[]" id="fai" tabindex="-1" aria-hidden="true" required>
            ...
            <div class="col-md-9">
                <div class="form-group-custom">
                    <textarea type="text" name="justif_new[]" class="form-control rounded-0 shadow-none " rows="3"
    ...
    <script type="text/template" id="medicament_labels">
    <section class="field-group">
                <div class="field-group row">
                    <div class="col-md-2">
                    </div>
                    ...
                    <div class="col-md-12">
                        <select class="form-control rounded-0 shadow-none multiselect-type_med"
                                name="medicament[]" id="type_med" tabindex="-1" aria-hidden="true" required>
                            <option value="">Sélectionner type</option>
                            <?php $__currentLoopData = $type_med; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($medicament->id); ?>"><?php echo e($medicament->type); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <br>
                    <br>
                    <div class="col-md-12">
                        <select class="form-control rounded-0 shadow-none medicament" name="medicament_id[]" id="medicament_id" tabindex="-1" aria-hidden="true" required>
                            <option value="">Sélectionner medicament</option>
                        </select>
                    </div>
                    <br>
                    <br>
                    <div class="col-md-9">
                      <div class="form-group-custom">
                            <input type="text" id="drug_advice" name="medicament_advice[]"
    ...
    <script type="text/template" id="test_labels">
        <div class="field-group row">
            ...
            <div class="form-group col-md-9">
                <div class="form-group-custom">
                    <input type="text" id="strength" name="description[]" class="form-control rounded-0 shadow-none "
                           placeholder="Remarque">
                </div>
            </div>
            <div class="col-md-3">
                <a type="button" class="btn rounded-0  btn-danger delete text-white btn-sm" align="center"><i
                        class='fa fa-trash  font-size-12'></i> <?php echo e(__('sentence.Remove')); ?></a>
    ...
    <script>
        ...
        $("#acteTable").on("dblclick", "td.editable-libelle", function () {
            var cell = $(this);
            var oldValue = cell.text();
            var inputField = $("<input type='text' class='form-control' value='" + oldValue + "'>");
            cell.html(inputField);
            inputField.focus();
            inputField.blur(function () {
                var newValue = inputField.val();
                cell.html(newValue);
                var hiddenInput = cell.closest("tr").find("input[name='libelle_act[]']");
                hiddenInput.val(newValue);
            });
        });
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/prescription/specialty/dentiste/edit.blade.php ENDPATH**/ ?>