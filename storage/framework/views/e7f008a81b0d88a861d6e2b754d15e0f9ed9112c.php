                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control paye" value="<?php echo e($billing_item->payer); ?>" readonly>
                                            </div>
                                        </div>
                                        <!-- Current Payer -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control new_payer" id="new_payer_<?php echo e($billing_item->id); ?>" value="0" required>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /var/www/dr-imanebenjelloun.tayssir.cloud/resources/views/billing/specialty/dentiste/reglement.blade.php ENDPATH**/ ?>