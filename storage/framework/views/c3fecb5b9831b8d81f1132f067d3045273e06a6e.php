        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ajouter une Dépense</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('depense.store')); ?>" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-6">
                                ...
                                <input type="number" class="form-control rounded-0 w-100 shadow-none" name="monton"
                                    id="monton">
                            </div>

                            <div class="form-group col-6">
                                <label for="" class="my__label">Type Dépenses <span
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dr-imanebenjelloun.tayssir.cloud/resources/views/depense/create.blade.php ENDPATH**/ ?>