                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo e(route('user.edit', ['id' => $user->id])); ?>"
                                        ...
                                        <a href="#" class="btn btn-outline-danger btn-circle btn-sm" data-toggle="modal"
                                            ...
                                            data-link="<?php echo e(route('patient.destroy', ['id' => $user->id])); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u459899255/domains/rmili.myclinic.ma/public_html/resources/views/user/all.blade.php ENDPATH**/ ?>