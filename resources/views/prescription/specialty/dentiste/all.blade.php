...
{{--                            <th class="text-center xxs__screen">Statut du paiement</th>--}}
                            ...
                            <th class="text-centre xxs__screen">Médecin</th>
...
{{--                                </td>--}}
                                ...
                                <td class="text-center">
                                    @php $doctor = App\User::find($prescription->User->Patient->dr_id); @endphp
                                    @if($doctor)
                                        <label class="badge badge-primary-soft">
                                ...
                                <td class="text-center">
                                    @if(Auth::user()->role == 'Médecin' && (Auth::id() == $prescription->User->Patient->dr_id || $prescription->User->Patient->dr_id == null))
...
{{--                                            </a>--}}
                                        ...
                                        @endif
                                    @else
                                        <a href="{{ url('prescription/specialty/dentiste/view/' . $prescription->id . '?user_id=' . $prescription->user_id) }}"
