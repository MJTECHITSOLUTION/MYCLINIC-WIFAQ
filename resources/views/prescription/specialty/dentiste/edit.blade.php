                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <option value="{{ $prescription->user_id }}">{{ $prescription->User->name }} -
                                ({{ calculateAgeWithMonths($prescription->User->Patient->birthday) }})
                            </option>
                        ...
                        <div class="form-group">
                            <div class="card-body text-center" style="padding: 0px;">
                                <img src="{{ asset('img/dent.png') }}" id="map-image"
                                ...
                                <div class="form-row">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" name="value[]" class="form-control"
                                               value="{{$rapport->value}}" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <br>
                                        <a href="{{ route('remove-rapport', ['id' => $rapport->id]) }}"
                                    ...
                                    <textarea class="form-control rounded-0 shadow-none analyse" name="rapport[]"
                                              placeholder="">{{$rapport->rapport}}</textarea>
                                ...
                                <select class="form-control act_input" id="acte" name="acte">
                                    ...
                                    @foreach($actes as $act)
                                        <option value="{{ $act->id }}" data-acte-ref="{{$act->ref}}"
                                                data-acte-cout="{{$act->cout}}">{{ $act->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <table id="acteTable" class="table table-striped table-bordered">
                            ...
                            @foreach($consultationact as $acte)
                                <tr>
                                    ...
                                    <td><a href="{{ route('remove-acte', ['id' => $acte->id]) }}" class="btn"><i
                                                class='fas fa-trash'></i></a></td>
                                    <input type="hidden" name="prescription_consultation_id[]" id="prescription_id"
                                           value="{{$acte->prescription_id}}">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <select
                                                    ...
                                                    required>
                                                    <option value="{{ $medicament->medicament_id }}">
                                                        {{ $medicament->medicament }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group-custom">
                                                    <input type="text" id="" name="medadvice[]"
                                                           class="form-control rounded-0 shadow-none"
                                                           placeholder="{{ __('sentence.Advice_Comment') }}"
                                                           value="{{ $medicament->drug_advice }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="{{ route('prescription_medicament.destroy', $medicament->medicament_id) }}"
                                                   class="btn rounded-0 btn-danger btn-sm text-white delete"
                                                   onclick="event.preventDefault(); deleteMedicament('{{ route('prescription_medicament.destroy', $medicament->medicament_id) }}');">
                                                    <i class="fa fa-trash font-size-12"></i> {{ __('sentence.Remove') }}
                                                </a>
                                            </div>
                ...
                <div class="field-group row">
                    ...
                    <div class="col-md-12">
                        <select class="form-control rounded-0 shadow-none multiselect-type_med"
                            ...
                            @foreach($type_med as $medicament)
                                <option value="{{ $medicament->id }}">{{ $medicament->type }}</option>
                            @endforeach
                        </select>
                    </div>
                    <br>
        ...
        <div class="field-group row">
            ...
            <div class="col-md-3">
                <a type="button" class="btn rounded-0  btn-danger delete text-white btn-sm" align="center"><i
                        class='fa fa-trash  font-size-12'></i> {{ __('sentence.Remove') }}</a>
